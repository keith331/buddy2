...
# Read raw data
fr0 = pd.read_excel('test_use 2020-7-3 SPK.xlsx',sheet_name='Fundamental ...tim1 (refMic1))')
fr1 = pd.read_excel('test_use 2020-7-3 SPK.xlsx',sheet_name='Fundamental ...tim1 (refMic2))')
# fr2 = pd.read_excel('DUT FR.xlsx',sheet_name='Normalized FR Mic 2')
# fr3 = pd.read_excel('DUT FR.xlsx',sheet_name='Normalized FR Mic 3')
fr_data = [fr0,fr1]



# sens0 = pd.read_excel('test_use 2020-4-17 MIC.xlsx',sheet_name='SensitivityL')
# sens1 = pd.read_excel('test_use 2020-4-17 MIC.xlsx',sheet_name='SensitivityR')
...
thd0 = pd.read_excel('test_use 2020-7-3 SPK.xlsx',sheet_name='Total Distor...tim1 (refMic1))')
thd1 = pd.read_excel('test_use 2020-7-3 SPK.xlsx',sheet_name='Total Distor...tim1 (refMic2))')
...
def fr_chart():
    ...
    style(ax1a)
    plt.ylabel('Variance (dBV)', fontsize=16)
